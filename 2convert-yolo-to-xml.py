...
for key in os.listdir():
    if os.path.splitext(os.path.basename(key))[1] == '':
      ...
      folder_holding_yolo_files =os.getcwd()
      yolo_class_list_file = os.getcwd() + r'\classes.txt'
      # folder_holding_yolo_files = "Enter the path to the yolo files: "
      # yolo_class_list_file = "Enter the path to the file that has the yolo classes (typically classes.txt): "
